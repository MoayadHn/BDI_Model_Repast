...
public class ReLogoTurtle extends BaseTurtle{
	...
	public AgentSet<bdi_model.relogo.UserTurtle> hatchUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserTurtle")
	public AgentSet<bdi_model.relogo.UserTurtle> hatchUserTurtles(int number) {
	...
	public bdi_model.relogo.UserLink createUserLinkFrom(Turtle t, Closure closure){
		bdi_model.relogo.UserLink link = (bdi_model.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this);
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public bdi_model.relogo.UserLink createUserLinkFrom(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a, Closure closure){
		AgentSet<bdi_model.relogo.UserLink> links = new AgentSet<bdi_model.relogo.UserLink>();
		for(Turtle t : a){
			links.add((bdi_model.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this));
		}
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public bdi_model.relogo.UserLink createUserLinkTo(Turtle t, Closure closure){
		bdi_model.relogo.UserLink link = (bdi_model.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,t);
		if (closure != null){
			this.ask(link,closure);
		}
		return link;
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public bdi_model.relogo.UserLink createUserLinkTo(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a, Closure closure){
		AgentSet<bdi_model.relogo.UserLink> links = new AgentSet<bdi_model.relogo.UserLink>();
		for(Object t : a){
			if (t instanceof Turtle){
				links.add((bdi_model.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,(Turtle)t));
			}
		}
		if (closure != null){
			this.ask(links,closure);
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public bdi_model.relogo.UserLink inUserLinkFrom(Turtle t){
		return (bdi_model.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(t,this);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> myInUserLinks(){
		AgentSet<bdi_model.relogo.UserLink> result = new AgentSet<bdi_model.relogo.UserLink>();
		for(Object o :  this.getMyObserver().getNetwork("UserLink").getInEdges(this)){
			if (o instanceof bdi_model.relogo.UserLink){
				result.add((bdi_model.relogo.UserLink) o);
			}
		}
		return result;
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> myOutUserLinks(){
		AgentSet<bdi_model.relogo.UserLink> result = new AgentSet<bdi_model.relogo.UserLink>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public bdi_model.relogo.UserLink outUserLinkTo(Turtle t){
		return (bdi_model.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(this, t);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserLink")
	public AgentSet<bdi_model.relogo.UserLink> myUserLinks(){
		AgentSet<bdi_model.relogo.UserLink> result = new AgentSet<bdi_model.relogo.UserLink>();
