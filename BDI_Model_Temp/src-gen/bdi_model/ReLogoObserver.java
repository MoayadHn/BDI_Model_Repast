...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<bdi_model.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserTurtle")
	public AgentSet<bdi_model.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserTurtle")
	public AgentSet<bdi_model.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<bdi_model.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("bdi_model.relogo.UserTurtle")
	public AgentSet<bdi_model.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<bdi_model.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(bdi_model.relogo.UserTurtle.class)) {
	...
	public AgentSet<bdi_model.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(bdi_model.relogo.UserLink.class)) {
	...
	public bdi_model.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (bdi_model.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
